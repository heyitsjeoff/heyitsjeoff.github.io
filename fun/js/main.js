    ...
    _createClass(CONSOLE, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                'div',
                { className: 'console-repl', onClick: this.selectInput },
                _react2['default'].createElement(
                    'div',
                    { className: 'console-header' },
                    'node'
                ),
                _react2['default'].createElement('div', { className: 'console-body' }),
                _react2['default'].createElement('input', {
                    className: 'console-input',
                    onChange: this.props.inputReader,
...
var _textTyper = require('text-typer');

var _textTyper2 = _interopRequireDefault(_textTyper);
...
var _funFacts = require('./fun-facts');

var _funFacts2 = _interopRequireDefault(_funFacts);
...
var APP = (function (_React$Component) {
  ...
  function APP(props) {
    ...
    this.inputReader = this.inputReader.bind(this);
  ...
  _createClass(APP, [{
    key: 'getTyper',
    value: function getTyper(speed) {
      var el = document.getElementsByClassName('console-body')[0];
      var typer = (0, _textTyper2['default'])(el);
      typer.opts.speed = speed;
      return typer;
    }
  }, {
    key: 'initializeWelcome',
    value: function initializeWelcome() {
      var _this = this;
      ...
      setTimeout(function () {
        (0, _jquery2['default'])('.greetings').fadeOut(500);
    ...
    value: function handleKeyDown(e) {
      ...
      if (e.keyCode === 38) {
        var inputToUpdate = undefined;
        if (this.state.commands[this.state.commandIdx]) {
          inputToUpdate = this.state.commands[this.state.commandIdx];
          this.setState({
            inputVal: inputToUpdate,
            commands: this.state.commands,
            commandIdx: this.state.commandIdx + 1
          });
        }
      }
      if (e.keyCode === 40) {
        var inputToUpdate = undefined;
        if (this.state.commands[this.state.commandIdx - 1]) {
          inputToUpdate = this.state.commands[this.state.commandIdx - 1];
          this.setState({
            inputVal: inputToUpdate,
            commands: this.state.commands,
            commandIdx: this.state.commandIdx - 1
          });
        } else if (this.state.commandIdx === 0) {
          this.setState({
            inputVal: '',
            commands: this.state.commands,
            commandIdx: 0
    ...
    value: function runCommand() {
      var typer = this.getTyper(5);
      var command = this.state.inputVal;
      ...
      if (_commands2['default'][command]) {
        _commands2['default'][command].forEach(function (ln) {
          typer.print(ln);
        });
        this.executeCommand(command);
      } else {
        typer.print('> command not found; type help for a list of available commands');
      }
    }
  }, {
    key: 'executeCommand',
    value: function executeCommand(command) {
      ...
      if (command === 'fun fact') {
        var factChoice = Math.floor(Math.random() * _funFacts2['default'].length);
        var typer = this.getTyper(5);
        typer.print(_funFacts2['default'][factChoice]);
      }
      if (command === 'tagpro') {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement('h1', { className: 'greetings' }),
...
},{"./commands":161,"./console":162,"./fun-facts":163,"jquery":2,"react":157,"text-typer":158}],165:[function(require,module,exports){
'use strict';
...
_react2['default'].render(_react2['default'].createElement(_componentsHome2['default'], null), document.getElementById('main'));


},{"./components/home":164,"react":157}]},{},[165])
